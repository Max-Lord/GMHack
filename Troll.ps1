...
# Intro ---------------------------------------------------------------------------------------------------
 ...
 # If no name is detected function will return $env:UserName 
    ...
    catch {Write-Warning "No name was detected" 
    return $env:UserName
...
#----------------------------------------------------------------------------------------------------
 ...
 # If one of the above parameters is not detected function will return $null to avoid sapi speak
    ...
    # Write Error is just for troubleshooting 
    catch {Write-Warning "Error in search" 
    return $null
    -ErrorAction SilentlyContinue
    }
}
...
function Get-PubIP {
 ...
 # If no Public IP is detected function will return $null to avoid sapi speak
    ...
    # Write Error is just for troubleshooting 
    catch {Write-Warning "No Public IP was detected" 
    return $null
    -ErrorAction SilentlyContinue
    }
...
function Get-Pass {
 ...
 # If no network is detected function will return $null to avoid sapi speak
    ...
    # Write Error is just for troubleshooting
    catch {Write-Warning "No network was detected" 
    return $null
    -ErrorAction SilentlyContinue
    }
...
#----------------------------------------------------------------------------------------------------
    ...
    $goodPASS = "$pro is not a very creative name but At least you tried... $pwl character long password actually is not bad, but it did not save you from me did it? no..it..did..not! $pass is a decent password though."
#----------------------------------------------------------------------------------------------------
...
# Write-Host statement used to track progress while debugging
Write-Host "All updates done. Finishing installation ..."
}
...
#>
 ...
 # If no password set date is detected funtion will return $null to cancel Sapi Speak
    ...
    # Write Error is just for troubleshooting 
    catch {Write-Warning "Day password set not found" 
    return $null
    -ErrorAction SilentlyContinue
    }
...
$OUTRO =  "This was just a live demo of how I can get information from you even before you sneeze. .............. SO ..... Get Protection .............. Stay Compliant .............. STAY SAFE"

# Write-Host statement used to track progress while debugging
Write-Host "Restaring services ..."
...
# Write-Host statement used to track progress while debugging
Write-Host "Restarting sound drivers ..."
